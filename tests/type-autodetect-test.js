...
describe('Petal - autodetect source type', function () {
  it( 'should detect AST', function () {
    var source = fs.readFileSync('./tests/fixtures/global.js');
    var ast = esprima.parse(source);
    var m = new Petal('./tests/fixtures/global.js', source, ast);
  ...
  it( 'should detect CJS', function () {
    ...
    var m = new Petal('./tests/fixtures/cjs.js', source);
  ...
  it( 'should detect SYSTEM', function () {
    ...
    var m = new Petal('./tests/fixtures/system.js', source);
    expect(m.type).to.equal('SYSTEM');
  });

  it( 'should detect GLOBAL', function () {
    var source = fs.readFileSync('./tests/fixtures/global.js');
    var m = new Petal('./tests/fixtures/global.js', source);
