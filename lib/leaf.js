...
var resolveModule = function ( child, name ) {
...
Leaf.prototype.remap = function(name) {
  return this._remap(name);
};

Leaf.prototype._remap = function(name) {
  ...
  this.nodes.forEach(function(node) {
    ...
    if (secondArg && secondArg.type === 'ArrayExpression') {
      ...
      this.imports[remaped] = secondArg.elements.map(function(element) {
        // console.log(element.value, remaped)
